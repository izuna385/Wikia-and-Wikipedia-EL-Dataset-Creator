...
python3 create_dataset.py -language en -dirpath_after_wikiextractor_preprocessing ./text/ \
                          -augmentation_with_title_set_string_match False -in_document_augmentation_with_its_title False \
                          -multiprocessing True -path_for_raw_xml enwiki-20210420-pages-articles-multistream.xml;